...
def context_prompt(chunk: str, document: str) -> str:
	return (
		...
		"Write exactly one short sentence that situates this chunk within the document. "
		"State which section or topic it belongs to and what it is about, so the chunk "
		"becomes self-describing without the surrounding document. "
		"Return only that sentence — no preamble, no explanation."
	)
...
# --- Recorded results (model=claude-haiku-4-5) ---
# added context names the topic: True
# Generated context sentence:
#   "In response to a major phishing breach, Northwind Robotics' Cybersecurity team
#    issued hardware security keys to all employees and made them mandatory for
#    administrative logins."
# The context correctly anchors the chunk to the cybersecurity/incident-response section.
