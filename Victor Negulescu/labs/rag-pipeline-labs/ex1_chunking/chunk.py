...
# --- Recorded results (python chunk.py) ---
# strategy                   chunks  answers intact
# size=160, overlap=0            28            8/9
# size=160, overlap=40           38            9/9
# section-based                   9            9/9
#
# The one no-overlap miss is a boundary cut through an answer string; overlap heals it.
# Section-based keeps all 9 because answers never cross heading boundaries.
#
# Prefer size-based+overlap for free-form text with no reliable structure (prose, logs).
# Prefer section-based when the document has consistent headings — it produces far
# fewer, cleaner chunks at no retrieval cost.
