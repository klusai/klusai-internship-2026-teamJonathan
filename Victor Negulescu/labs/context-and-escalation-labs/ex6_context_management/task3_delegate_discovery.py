...
CODE_SCOUT = AgentDefinition(
	...
	prompt=(
		"You are a code scout. Find one specific fact and return a compact answer — "
		"do NOT paste file contents.\n\n"
		"Task: find the effective HTTP retry limit used by the live client.\n\n"
		"Steps:\n"
		"1. Use Glob to list the files in the repo.\n"
		"2. Read config/settings.py to find where the retry policy is defined.\n"
		"3. Read client/http.py to confirm which config value the live client reads.\n"
		"4. Do NOT look at legacy/old_client.py — it has a hardcoded decoy value.\n\n"
		"Return exactly two lines:\n"
		"  Line 1: the retry limit value and the file:line where it is defined.\n"
		"  Line 2: the file that reads that value at runtime.\n"
		"Nothing else."
	),
