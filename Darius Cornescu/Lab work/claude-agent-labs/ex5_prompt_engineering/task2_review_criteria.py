...
CRITERIA = [
	...
	"Error handling: flag bare `except:` or `except Exception: pass` that swallows errors.",
	"Security: flag password/secret hashing with unsalted or fast hashes (e.g. MD5/SHA1); "
	"require a salted slow KDF (bcrypt/scrypt/argon2/pbkdf2).",
	"Correctness: flag use of a module (e.g. hashlib) without a corresponding import.",
	"Resource safety: flag files/connections/cursors opened without a context manager or close.",
]
