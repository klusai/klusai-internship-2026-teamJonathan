...
FEWSHOT = """\
"Clicking Export throws a 500 and the page crashes." -> bug
"The app logs me out at random after a few minutes." -> bug
"Please add the ability to filter reports by date range." -> feature
"Can you support exporting to PDF as well as CSV?" -> feature
"How do I reset my password from the settings page?" -> question
"Is there a limit on how many users I can invite?" -> question
"""
